...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_POST['copias'])) {
        ...
        if (!is_numeric($_POST['copias'])) {
            ...
            //Castea el numero introducido a integer para el filtrado
    ...
    if (isset($_POST['generos'])) {
        ...
        if (!is_array($_POST['generos'])) {
            ...
            //Recorre el array $genero y lo compara con los géneros válidos para evitar manipulaciones
            ...
            //Si no se a producido nigún error asigna a $generos el array enviado desde el formulario
